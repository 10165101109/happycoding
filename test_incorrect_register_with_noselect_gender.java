...
class test_incorrect_register_with_noselect_gender {
	WebDriver driver;
	@Test
	void test_incorrect_register_with_noselect_gender() {
		driver = new SafariDriver();
		  driver.get("http://127.0.0.1:8080/Time/login.jsp");
		  driver.findElement(By.className("pull-right")).click();
		  driver.findElement(By.id("inputUserName")).sendKeys("wrh");
		  driver.findElement(By.id("inputNumber")).sendKeys("12345678913");
